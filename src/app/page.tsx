    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      <section className="relative overflow-hidden py-16 lg:py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Logo */}
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full mb-6 lg:mb-8 animate-float shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center items-center px-4">
            <Link 
              href="/camera" 
              className="group relative inline-flex items-center px-6 py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-base lg:text-lg font-bold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 transform w-full sm:w-auto"
            >
              ...
              <svg className="w-4 h-4 lg:w-5 lg:h-5 mr-2 lg:mr-3 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link 
              href="/upload" 
              className="group inline-flex items-center px-6 py-3 lg:px-8 lg:py-4 bg-white/10 backdrop-blur-md text-white text-base lg:text-lg font-bold rounded-xl border-2 border-white/30 hover:bg-white/20 hover:border-white/50 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform w-full sm:w-auto"
            >
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/10 backdrop-blur-sm p-8 lg:p-16 rounded-2xl lg:rounded-3xl border border-white/20 shadow-2xl">
            <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-400 to-purple-500 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-6 lg:mb-8">
            ...
            <Link 
              href="/camera" 
              className="inline-flex items-center px-6 py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-base lg:text-lg font-bold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 transform"
            >
              <svg className="w-4 h-4 lg:w-5 lg:h-5 mr-2 lg:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
