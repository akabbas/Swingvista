      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-20 lg:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            {/* Logo */}
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-3xl mb-8 animate-float shadow-2xl">
            ...
            {/* Main heading */}
            <h1 className="text-6xl lg:text-7xl font-black bg-gradient-to-r from-gray-900 via-blue-600 to-cyan-600 bg-clip-text text-transparent mb-6 leading-tight">
              SwingVista
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                href="/camera" 
                className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-lg font-semibold rounded-2xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105"
              >
              ...
              <Link 
                href="/upload" 
                className="group inline-flex items-center px-8 py-4 bg-white text-gray-700 text-lg font-semibold rounded-2xl border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
              >
                <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link href="/camera" className="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 text-white p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:animate-pulse-glow">
                ...
                <p className="text-blue-100 text-base leading-relaxed">Real-time swing analysis with your camera for instant feedback</p>
              </div>
            </Link>

            <Link href="/upload" className="group relative overflow-hidden bg-gradient-to-br from-emerald-500 to-emerald-600 text-white p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-emerald-100 text-base leading-relaxed">Analyze recorded swing videos with detailed metrics</p>
              </div>
            </Link>

            <Link href="/compare" className="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 text-white p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-purple-100 text-base leading-relaxed">Track your progress over time with detailed comparisons</p>
              </div>
            </Link>

            <div className="group relative overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 text-white p-10 rounded-3xl shadow-2xl">
              <div className="text-center">
                ...
                <p className="text-orange-100 text-base leading-relaxed">Coming soon - Advanced AI coaching and personalized tips</p>
              </div>
            </div>
          </div>
        </section>
          ...
          {clubStats.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {clubStats.map((stat, index) => (
                <div key={stat.club} className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-200/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl">
                      <span className="text-gray-700 font-semibold">Total Swings</span>
                      <span className="font-bold text-xl text-blue-600">{stat.total_swings}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl">
                      <span className="text-gray-700 font-semibold">Avg Plane</span>
                      <span className="font-bold text-xl text-emerald-600">{stat.avg_swing_plane.toFixed(1)}°</span>
                    </div>
                    <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl">
                      <span className="text-gray-700 font-semibold">Avg Tempo</span>
                      <span className="font-bold text-xl text-purple-600">{stat.avg_tempo_ratio.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl">
                      <span className="text-gray-700 font-semibold">Last Swing</span>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-16 rounded-3xl border border-gray-200/50 shadow-xl text-center">
              ...
              <p className="text-gray-600 mb-8 text-lg">Start analyzing your swings to see detailed statistics and track your progress</p>
              <Link href="/camera" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
        ...
        <section>
          ...
          {recentSwings.length > 0 ? (
                    ...
                    {recentSwings.map((swing, index) => (
                      <tr key={swing.id} className="hover:bg-gray-50/50 transition-colors duration-200">
                        ...
                        <td className="px-8 py-6 whitespace-nowrap">
                          <Link 
                            href={`/swing/${swing.id}`} 
                            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-bold rounded-xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                          >
                            View Details
                          </Link>
                        </td>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-16 rounded-3xl border border-gray-200/50 shadow-xl text-center">
              ...
              <p className="text-gray-600 mb-8 text-lg">Your recent swing analysis will appear here</p>
              <Link href="/camera" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
                Start Analyzing
              </Link>
            </div>
